<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Listar.aspx.cs" Inherits="Aap.NetBD.Listar" %>
            ...
            <asp:Repeater ID="rptClientes" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="linkDetalhes" runat="server">
